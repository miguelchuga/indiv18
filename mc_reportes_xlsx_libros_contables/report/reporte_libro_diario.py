...
class LibroDiario(models.AbstractModel):
    ...
    def generate_xlsx_report(self, lines):
        ...
        sheet.write('F8','Debe',formatTituloCampo)
        sheet.write('G8','Haber',formatTituloCampo)
        ...
        for line in lines.libro_line:
            if line.tipo_linea != 'l':
                continue
            if line.documento != documento:
                #Esta condicion es para agregar los totales al final por documento
                if inicio != 1:
