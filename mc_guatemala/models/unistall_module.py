...
# Buscando contactos
domain = [("id", "=", 1042),]
fields = ["id","shortdesc", "author", "name",'state']
...
#_module = models.execute_kw(db, uid, password, 'ir.module.module', 'button_immediate_uninstall', [contacts[0]['id']])

#_module = models.execute_kw(
#    db, uid, password,
#     "ir.module.module", "button_immediate_uninstall", contacts[0]['id'])
